...
export function ComingSoon({ pillar, phase, blurb, bullets }: ComingSoonProps) {
  return (
    <div className="py-16">
      ...
      <h1 className="text-3xl font-semibold tracking-tight">{pillar}</h1>
      ...
      <Link
        href="/visualize"
        className="mt-8 inline-block rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary-hover"
      >
